...
class ModelCatalog(object):
    ...
    C2_DETECTRON_MODELS = {
        ...
        # fast-rcnn
        "36225147/fast_rcnn_R-50-FPN_1x": "08_39_09.L3obSdQ2",
        "36228880/fast_rcnn_R-101-FPN_1x": "09_25_03.tZuHkSpl",
        "36225401/mask_rcnn_R-50-FPN_1x": "08_42_04.MocEgrRW",
        # keypoints
    ...
    def get(name):
        ...
        if name.startswith("VGGImageNetPretrained"):
            return ModelCatalog.get_vgg_imagenet_pretrained(name)
    ...
    @staticmethod
    def get_vgg_imagenet_pretrained(name):
        name = name[len("VGGImageNetPretrained/"):]
        url = ModelCatalog.VGG_IMAGENET_MODELS[name]
        return url